...
This is an interview exercise for the FullStack Web Developer. You **DO NOT NECESSARILY need
to complete 100% of them**: you can choose to complete as many as you want.

We give you until the end of this week to submit a solution, so that you can do it at your own pace. We are aware that you might
have other commitments, so we are not expecting you to work on this full-time. You will be evaluated based on the
quality of your work, not on the time you spent on it. You must use React, NextJS, TailwindCSS and TypeScript.
...
- Design Patterns
- Project Structure
- Provided Documentation (comments throughout the code)
...
If you need some inspiration, you can take a look at [UI example folder](public/images/ui-examples), where you can find some
...
Your will have to setup a simple server that you can use to fetch the data. [There is a db-mock json](data/db-mock.json)
